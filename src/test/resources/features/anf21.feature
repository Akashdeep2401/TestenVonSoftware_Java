# language: de
Funktionalität: (21)Das System muss gewährleisten, dass bei der Aktion „Bewegen“ ein Froschstein mehrmals springen darf, aber nicht so dass dieser an der Ursprungsposition bleibt.
